    ...
    <div class="wrapper-lienhe">
        ...
        <div class="container-lienhe_right">
            <div class="container-lienhe_right_form">
                ...
                <button class="container-lienhe_right_form_bt" type="submit" value="Gửi liên hệ" name="submit"></button>
                <button class="container-lienhe_right_form_bt" type="reset" value="Soạn lại" ></button>
            </div>
        </div>
    </div>
</div>
